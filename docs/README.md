...
- title: ✨ Test everything
  details: Design is a never-ending process of making assumptions and validating them. Prototyping with code allows you to test ideas early and keep testing them at every stage of the design process. This means that you can build your designs on educated decisions, not guesses.
